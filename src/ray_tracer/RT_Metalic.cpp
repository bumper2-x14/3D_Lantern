...
RT_Metalic::RT_Metalic(const Color& _albedo, double _fuzz) : albedo(_albedo), fuzz(fuzz < 1 ? fuzz : 1) {}

bool RT_Metalic::rayScatter(const Rayd& ray_in, const RT_Record& rec, 
